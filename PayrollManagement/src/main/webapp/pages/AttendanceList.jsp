		...
		<div class="panel panel-default ors-form-pannel">
			...
			<div class="panel-body">
				...
				<div class="ors-justify-center">
					<sf:form action="${addSearch }" method="post" cssClass="form-inline " commandName="form">
						<s:bind path="name">
				...
				<sf:form action="${addSearch }" method="post"
					...
					<table id="listTable"
						...
						<thead>
							<tr>
								<th><span class="btn btn-default btn-sm"> 
								<input type="checkbox" id="selectall"> <s:message code="lable.selectAll" />
								</span></th>
