...
import in.co.payroll.mgt.form.SalaryForm;
import in.co.payroll.mgt.service.SalaryServiceInt;
...
public class SalaryCtl extends BaseCtl {
	...
	public String display(@RequestParam(required = false) Long id, @ModelAttribute("form") SalaryForm form,
			Model model) {
