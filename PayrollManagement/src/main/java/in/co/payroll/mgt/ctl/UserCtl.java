...
import in.co.payroll.mgt.form.ChangePasswordForm;
import in.co.payroll.mgt.form.MyProfileForm;
import in.co.payroll.mgt.form.UserForm;
import in.co.payroll.mgt.service.RoleServiceInt;
import in.co.payroll.mgt.service.UserServiceInt;
import in.co.payroll.mgt.util.DataUtility;
...
public class UserCtl extends BaseCtl {
	...
	public String submitProfile(Locale locale, HttpSession session, @ModelAttribute("form") @Valid MyProfileForm form,
